export const Navbar = () => {
    return (
        <div className="nav-bar">
            <div className="logo">
            <svg height="10rem" viewBox="0 -109.31 300 300" xmlns="http://www.w3.org/2000/svg">
                <g fill="red">
            ...
            <select id=":R5ajalalal95:" name="LanguageSelect" data-uia="language-picker-header" className="drop-down">
